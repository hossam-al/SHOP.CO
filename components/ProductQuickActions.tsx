...
export function ProductQuickActions({
  ...
  return (
    <>
      <div className={compact ? "grid grid-cols-[1fr_auto] gap-2" : "grid gap-2 sm:grid-cols-[136px_1fr_auto]"}>
        {!compact ? (
          <div className="flex h-11 items-center justify-between rounded-full bg-[var(--background-soft)] px-2 font-bold text-black">
            <button
              type="button"
        ...
        >
          ...
          <span className="sr-only">{saved ? "Item is already in wishlist" : t("addWishlist")}</span>
        </button>
      </div>

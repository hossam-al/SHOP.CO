...
import {
  CustomerReviewsControls,
  CustomerReviewsSlider,
} from "@/components/feedback/CustomerReviewsSlider";
    ...
    <>
      ...
      <section id="new-arrivals" className="container-page py-16">
        ...
        <div className="mt-9 text-center">
          <Link className="btn-secondary min-w-52" href="/PLP">
            {home("secondaryCta")}
          </Link>
        </div>
      </section>
          ...
          {categories.map((category, index) => {
            ...
            return (
              ...
              >
                ...
                <img
                  src={encodeURI(
                    `/images/styles/${styleImages[category.slug] ?? `image ${11 + index}.png`}`,
                  )}
      ...
      <section className="w-full overflow-hidden py-20">
        <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-wrap items-end justify-between gap-5">
            ...
            <CustomerReviewsControls locale={locale} />
          </div>
          <CustomerReviewsSlider />
        </div>
      </section>
